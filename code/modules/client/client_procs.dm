	...
	//SECURITY//
	////////////
#define TOPIC_SPAM_DELAY 10 //2 ticks is about 2/10ths of a second; it was 4 ticks, but that caused too many clicks to be lost due to lag
#define UPLOAD_LIMIT 102400 //Restricts client uploads to the server to 1MB //Boosted this thing. What's the worst that can happen?
