...
/obj/structure/machinery/reagent_analyzer/proc/print_report(result, reason)
	...
	report.info += "<BR><HR><font size = \"1\"><I>This report was automatically printed by the A-XRF Scanner.<BR>The [MAIN_SHIP_NAME], [time2text(world.timeofday, "MM/DD")]/[GLOB.game_year], [game_time_timestamp()]</I></font><BR>\n<span class=\"paper_field\"></span>"
