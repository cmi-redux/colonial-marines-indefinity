/obj/item/clothing/accessory/medal/platinum/artyom_armagedon
	name = "Платиновая Медаль За Участие В Армагедоне"
	desc = "Награда К Которой Приставлен 'Johnny Vietnam', заслуженно полученная во время страданий и агоний под гнетом злых духов."
...
/obj/item/clothing/suit/storage/marine/fluff/verb/toggle_squad_markings()
	...
	if(!usr.can_action || usr.is_mob_restrained() || !usr.loc || !isturf(usr.loc))
