...
DEFINE_BITFIELD(bt_unlock_flags, list(
	"UNLOCK_ID" = BOLT_TERMINAL_UNLOCK_ID,
	"UNLOCK_TEMP" = BOLT_TERMINAL_UNLOCK_TEMP,
))
...
DEFINE_BITFIELD(bt_shoot_flags, list(
	"AIMING" = BOLT_TERMINAL_AIMING,
	"AIMED" = BOLT_TERMINAL_AIMED,
	"FIRING" = BOLT_TERMINAL_FIRING,
))
...
/obj/structure/machinery/bolt_control/panel/attack_hand(mob/user)
