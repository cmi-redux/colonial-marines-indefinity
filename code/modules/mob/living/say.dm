GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	":f" = SQUAD_MARINE_6, ".f" = SQUAD_MARINE_6, "#f" = RADIO_CHANNEL_PMC_MED,
	...
	":а" = SQUAD_MARINE_6, ".а" = SQUAD_MARINE_6, "#а" = RADIO_CHANNEL_PMC_MED,
	...
	":л" = SQUAD_MARINE_SOF, ".л" = SQUAD_MARINE_SOF, "#л" = RADIO_CHANNEL_WY_WO,
