...
/datum/xeno_mutation/strain/Vampire
...
/datum/xeno_mutation/strain/Vampire/apply_mutator(datum/mutator_set/individual_mutations/mutator_set)
	. = ..()
	if (. == FALSE)
		return
	...
	lurker.plasmapool_modifier_mult = 0
