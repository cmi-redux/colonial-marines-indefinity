...
/mob/living/carbon/xenomorph/crusher/Initialize(mapload, mob/living/carbon/xenomorph/old_xeno, datum/faction/hive_to_set)
	. = ..()
...
/mob/living/carbon/xenomorph/proc/handle_collision(atom/target)
	...
	//Barricade collision
		...
		var/obj/structure/machinery/mounted_defence/MD = target
		visible_message(SPAN_DANGER("[src] rams [MD]!"), SPAN_XENODANGER("You ram [MD]!"))
