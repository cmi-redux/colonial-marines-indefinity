...
/obj/effect/alien/weeds/Initialize(mapload, obj/effect/alien/weeds/node/node, mob/living/carbon/xenomorph/xenomorph, datum/faction/faction_to_set, use_node_strength = TRUE, do_spread = TRUE)
	. = ..()
