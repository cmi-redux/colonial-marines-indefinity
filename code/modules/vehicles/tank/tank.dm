...
/obj/vehicle/multitile/tank/Initialize()
	. = ..()
	SSmapview.add_marker(src, "vehicle_tank")
...
/obj/effect/vehicle_spawner/tank
	...
	pixel_x = -48
	pixel_y = -48
	type_for_spawn = /obj/vehicle/multitile/tank

/obj/effect/vehicle_spawner/tank/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)

//PRESET: turret, treads installed
/obj/effect/vehicle_spawner/tank/plain/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)

//PRESET: no hardpoints
/obj/effect/vehicle_spawner/tank/hull/load_hardpoints(obj/vehicle/multitile/multitile)
	return
...
/obj/effect/vehicle_spawner/tank/decrepit/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/support/artillery_module)
	multitile.add_hardpoint(new /obj/item/hardpoint/armor/paladin)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
	for(var/obj/item/hardpoint/holder/tank_turret/TT in multitile.hardpoints)
		TT.add_hardpoint(new /obj/item/hardpoint/primary/cannon)
		TT.add_hardpoint(new /obj/item/hardpoint/secondary/m56cupola)
		break

//PRESET: default hardpoints
/obj/effect/vehicle_spawner/tank/fixed/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/support/artillery_module)
	multitile.add_hardpoint(new /obj/item/hardpoint/armor/paladin)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
...
//PRESET: minigun kit
/obj/effect/vehicle_spawner/tank/fixed/minigun/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/support/weapons_sensor)
	multitile.add_hardpoint(new /obj/item/hardpoint/armor/ballistic)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
	for(var/obj/item/hardpoint/holder/tank_turret/TT in multitile.hardpoints)
...
/obj/effect/vehicle_spawner/tank/fixed/flamer/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/support/overdrive_enhancer)
	multitile.add_hardpoint(new /obj/item/hardpoint/armor/ballistic)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
	for(var/obj/item/hardpoint/holder/tank_turret/TT in multitile.hardpoints)
...
/obj/effect/vehicle_spawner/tank/fixed/autocannon/load_hardpoints(obj/vehicle/multitile/multitile)
	multitile.add_hardpoint(new /obj/item/hardpoint/support/artillery_module)
	multitile.add_hardpoint(new /obj/item/hardpoint/armor/ballistic)
	multitile.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)
	multitile.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret)
