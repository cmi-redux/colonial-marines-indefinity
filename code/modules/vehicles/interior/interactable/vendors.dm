...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("M39 Extended Magazine", 0, /obj/item/ammo_magazine/smg/m39/extended, VENDOR_ITEM_REGULAR),
		list("M41A MK2 Extended Magazine", 0, /obj/item/ammo_magazine/rifle/extended, VENDOR_ITEM_REGULAR),
		...
		list("Large Incinerator Tank (G) (Phosphorus Gas)", 0, /obj/item/ammo_magazine/flamer_tank/large/G, VENDOR_ITEM_REGULAR),

		list("RESTRICTED FIREARM AMMUNITION", -1, null, null),
		list("M240 Incinerator Tank", 1, /obj/item/ammo_magazine/flamer_tank, VENDOR_ITEM_REGULAR),
		list("M41A MK1 Magazine", 0, /obj/item/ammo_magazine/rifle/m41aMK1, VENDOR_ITEM_REGULAR),
		list("M41AE2 Box Magazine", 0, /obj/item/ammo_magazine/rifle/lmg, VENDOR_ITEM_REGULAR),
		list("M41AE2 Holo Target Rounds", 0, /obj/item/ammo_magazine/rifle/lmg/holo_target, VENDOR_ITEM_REGULAR),
		...
		list("AMMUNITION BOXES", -1, null, null),
		list("Rifle Ammunition Box", 0, /obj/item/ammo_box/rounds, VENDOR_ITEM_REGULAR),
