...
/obj/structure/interior_wall/get_projectile_hit_boolean(obj/item/projectile/proj)
	return FALSE
...
/obj/effect/vehicle_roof/get_projectile_hit_boolean(obj/item/projectile/proj)
	return FALSE
