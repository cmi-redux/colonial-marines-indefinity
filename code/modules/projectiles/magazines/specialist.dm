...
/obj/item/ammo_magazine/sniper/incendiary
	...
	ammo_preset = list(/datum/ammo/bullet/sniper/incendiary)
...
/obj/item/ammo_magazine/sniper/flak
	...
	ammo_preset = list(/datum/ammo/bullet/sniper/flak)
	ammo_band_color = AMMO_BAND_COLOR_IMPACT

//M42B Magazine
/obj/item/ammo_magazine/sniper/anti_materiel
	name = "XM42B marksman magazine (10x99mm)"
	desc = "A magazine of caseless 10x99mm anti-materiel rounds."
	max_rounds = 8
	caliber = CALIBER_10X99MM
	ammo_preset = list(/datum/ammo/bullet/sniper/anti_materiel)
...
/obj/item/ammo_magazine/sniper/elite
	...
	ammo_preset = list(/datum/ammo/bullet/sniper/elite)
...
/obj/item/ammo_magazine/sniper/svd
	name = "Type-88 Magazine (7.62x54mmR)"
	desc = "A large caliber magazine for the Type-88 designated marksman rifle."
	caliber = CALIBER_7_62X54MM
	icon = 'icons/obj/items/weapons/guns/ammo_by_faction/upp.dmi'
	icon_state = "type88mag"
	ammo_preset = list(/datum/ammo/bullet/sniper/upp)
	max_rounds = 12
...
/obj/item/ammo_magazine/rifle/m4ra/custom
	...
	icon_state = "a19"
	ammo_preset = list(/datum/ammo/bullet/rifle/m4ra)
	max_rounds = 18
...
/obj/item/ammo_magazine/rifle/m4ra/custom/incendiary
	...
	ammo_preset = list(/datum/ammo/bullet/rifle/m4ra/incendiary)
	max_rounds = 18
	gun_type = /obj/item/weapon/gun/rifle/m4ra_custom
	ammo_band_color = AMMO_BAND_COLOR_INCENDIARY
...
/obj/item/ammo_magazine/rifle/m4ra/custom/impact
	...
	ammo_preset = list(/datum/ammo/bullet/rifle/m4ra/impact)
	max_rounds = 18
	gun_type = /obj/item/weapon/gun/rifle/m4ra_custom
...
/obj/item/ammo_magazine/smartgun/dirty
	...
	ammo_preset = list(/datum/ammo/bullet/smartgun/dirty)
...
/obj/item/ammo_magazine/rocket/attack(mob/living/carbon/human/M, mob/living/carbon/human/user)
	...
	if(M.dir != user.dir || M.loc != get_step(user, user.dir))
		...
		return
	if(in_hand.current_mag.ammo_position > 0)
	...
	if(!do_after(user, (in_hand.current_mag.transfer_delay * M.get_skill_duration_multiplier(SKILL_FIREARMS) / 2), INTERRUPT_ALL, BUSY_ICON_FRIENDLY, M, INTERRUPT_ALL, BUSY_ICON_GENERIC))
...
/obj/item/ammo_magazine/rocket/wp
	...
	ammo_preset = list(/datum/ammo/rocket/wp)
...
/obj/item/ammo_magazine/rocket/custom
	...
	ammo_preset = list(/datum/ammo/rocket/custom)
...
/obj/item/ammo_magazine/rocket/m57a4
	...
	max_rounds = 4
	ammo_preset = list(/datum/ammo/rocket/wp/quad)
	gun_type = /obj/item/weapon/gun/launcher/rocket/m57a4
	transfer_delay = 20 SECONDS
