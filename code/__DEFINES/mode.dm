...
#define ROLES_CRASH_USCM	list(JOB_CRASH_CO, JOB_CRASH_SYNTH, JOB_CRASH_CHIEF_ENGINEER, JOB_CRASH_CMO, JOB_CRASH_SQUAD_LEADER, JOB_CRASH_SQUAD_SPECIALIST, JOB_CRASH_SQUAD_SMARTGUNNER, JOB_CRASH_SQUAD_MEDIC, JOB_CRASH_SQUAD_ENGINEER, JOB_CRASH_SQUAD_MARINE)
...
#define WHITELIST_YAUTJA_LEADER (1<<3)
#define WHITELIST_PREDATOR (WHITELIST_YAUTJA|WHITELIST_YAUTJA_LEGACY|WHITELIST_YAUTJA_COUNCIL|WHITELIST_YAUTJA_LEADER)

#define WHITELIST_COMMANDER (1<<4)
#define WHITELIST_COMMANDER_COUNCIL (1<<5)
#define WHITELIST_COMMANDER_LEADER (1<<6)
///Former CO senator/whitelist overseer award
#define WHITELIST_COMMANDER_COLONEL (1<<79)

#define WHITELIST_JOE (1<<8)
#define WHITELIST_SYNTHETIC (1<<9)
#define WHITELIST_SYNTHETIC_COUNCIL (1<<10)
#define WHITELIST_SYNTHETIC_LEADER (1<<11)

///Senior Enlisted Advisor, auto granted by R_MENTOR
#define WHITELIST_MENTOR (1<<12)
...
#define WHITELISTS_LEGACY_COUNCIL (WHITELIST_COMMANDER_COUNCIL_LEGACY)
