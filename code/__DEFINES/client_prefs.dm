...
#define TOGGLE_ABILITY_DEACTIVATION (1<<18) // This toggles whether selecting the same ability again can toggle it off
#define TOGGLE_GUN_AMMO_COUNTER (1<<19) // Needs to start on.
