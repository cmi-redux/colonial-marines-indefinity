...
#define FACTION_LIST_MARINE			list(FACTION_USCM, FACTION_MARINE, FACTION_MARSOC)
#define FACTION_LIST_WY				list(FACTION_WY, FACTION_PMC, FACTION_WY_DEATHSQUAD)
#define FACTION_LIST_HUMANOID		list(FACTION_NEUTRAL, FACTION_CLF, FACTION_UPP, FACTION_FREELANCER, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA) + FACTION_LIST_MARINE + FACTION_LIST_WY
#define FACTION_LIST_XENOMORPH		list(FACTION_XENOMORPH_NORMAL, FACTION_XENOMORPH_CORRUPTED, FACTION_XENOMORPH_ALPHA, FACTION_XENOMORPH_BRAVO, FACTION_XENOMORPH_CHARLIE, FACTION_XENOMORPH_DELTA, FACTION_XENOMORPH_FERAL, FACTION_XENOMORPH_FORSAKEN, FACTION_XENOMORPH_TAMED, FACTION_XENOMORPH_MUTATED, FACTION_XENOMORPH_YAUTJA)
...
#define RELATIONS_UNKNOWN	1
#define RELATIONS_WAR		2
#define RELATIONS_HOSTILE	3
#define RELATIONS_STRAINED	4
#define RELATIONS_BAD		5
#define RELATIONS_NEUTRAL	6
#define RELATIONS_FRIENDLY	7
#define RELATIONS_ALLIANCE	8
#define FACTION_SELF		9
