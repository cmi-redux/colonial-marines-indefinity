...
#define JOB_SQUAD_SPEC_LIST list(JOB_SQUAD_SPECIALIST, JOB_WO_SQUAD_SPECIALIST, JOB_CRASH_SQUAD_SPECIALIST, JOB_UPP_SPECIALIST)
#define JOB_SQUAD_MAIN_SUP_LIST list(JOB_SQUAD_SMARTGUN, JOB_WO_SQUAD_SMARTGUNNER, JOB_CRASH_SQUAD_SMARTGUNNER)
#define JOB_SQUAD_LEADER_LIST list(JOB_SQUAD_LEADER, JOB_WO_SQUAD_LEADER, JOB_CRASH_SQUAD_LEADER, JOB_MARINE_RAIDER_SL, JOB_UPP_LEADER)
