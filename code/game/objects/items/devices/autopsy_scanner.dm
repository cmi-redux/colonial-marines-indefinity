...
/obj/item/device/autopsy_scanner/verb/print_data()
	...
	if(timeofdeath)
		scan_data += "<b>Time of death:</b> [game_time_timestamp("hh:mm", timeofdeath)] [time2text(timeofdeath, "DDD MMM DD [GLOB.game_year]")]<br><br>"
	...
	for(var/wdata_idx in wdata)
		...
		scan_data += "Approximate time of wound infliction: [game_time_timestamp("hh:mm", age)] [time2text(age, "DDD MMM DD [GLOB.game_year]")]<br>"
