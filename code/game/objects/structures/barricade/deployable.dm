...
/obj/item/stack/folding_barricade/attack_self(mob/user)
	...
	var/turf/open/open_turf = usr.loc
	var/obj/structure/blocker/anti_cade/anti_cade = locate(/obj/structure/blocker/anti_cade) in open_turf // for M2C HMG, look at smartgun_mount.dm
