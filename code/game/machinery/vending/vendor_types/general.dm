...
GLOBAL_LIST_INIT(cm_vending_walkman, list(
	...
	list("Old Cassette", 10, /obj/item/device/cassette_tape/lybe, VENDOR_ITEM_REGULAR),
	list("Black Stripe Cassette", 10, /obj/item/device/cassette_tape/sad, VENDOR_ITEM_REGULAR),
	list("Red Cassette", 10, /obj/item/device/cassette_tape/sovietwave, VENDOR_ITEM_REGULAR),
