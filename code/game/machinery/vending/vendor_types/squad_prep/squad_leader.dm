...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("Essential SL Kit", 0, /obj/effect/essentials_set/leader, VENDOR_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),

		list("SQUAD KIT (CHOOSE 1, for yourself or your squad)", 0, null, null, null),
		list("M4RA Sniper Kit", 0, /obj/item/storage/box/kit/mini_sniper, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		list("M240 Pyrotechnician Support Kit", 0, /obj/item/storage/box/kit/mini_pyro, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		list("M41AE2 Heavy Pulse Rifle", 0, /obj/item/storage/box/guncase/lmg, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		list("MOU-53 Shotgun", 0, /obj/item/storage/box/guncase/mou53, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
		list("Basic Engineering Supplies", 0, /obj/item/storage/box/kit/engineering_supply_kit, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_leader, list(
		...
		list("Armor", 0, /obj/item/clothing/suit/storage/marine/leader, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("Headset", 0, /obj/item/device/radio/headset/almayer/marine, VENDOR_CAN_BUY_EAR, VENDOR_ITEM_MANDATORY),
		list("Helmet", 0, /obj/item/clothing/head/helmet/marine/leader, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		...
		list("Fuel Tank Strap Pouch", 0, /obj/item/storage/pouch/flamertank, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
