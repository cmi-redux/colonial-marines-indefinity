...
GLOBAL_LIST_INIT(cm_vending_clothing_tl, list(
		...
		list("M4 Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/rto, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		...
		list("Essential Fireteam Leader Utilities", 0, /obj/effect/essentials_set/tl, VENDOR_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
