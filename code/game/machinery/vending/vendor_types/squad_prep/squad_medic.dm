...
GLOBAL_LIST_INIT(cm_vending_gear_medic, list(
		...
		list("Experemental Medic Essentials", 45, /obj/effect/essentials_set/experemental_medic_kit, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Map", 0, /obj/item/map/current_map, VENDOR_CAN_BUY_KIT, VENDOR_ITEM_MANDATORY),
		...
		list("Vial Pouch (Full)", 0, /obj/item/storage/pouch/vials/full, VENDOR_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
