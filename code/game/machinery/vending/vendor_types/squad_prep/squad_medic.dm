...
GLOBAL_LIST_INIT(cm_vending_gear_medic, list(
		...
		list("Essential Medical Set", 0, /obj/effect/essentials_set/medic, VENDOR_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Uniform", 0, /obj/item/clothing/under/marine/medic, VENDOR_CAN_BUY_UNIFORM, VENDOR_ITEM_MANDATORY),
		...
		list("Helmet", 0, /obj/item/clothing/head/helmet/marine/medic, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		...
		list("Vial Pouch (Full)", 0, /obj/item/storage/pouch/vials/full, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
