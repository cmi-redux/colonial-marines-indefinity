...
GLOBAL_LIST_INIT(cm_vending_gear_smartgun, list(
		...
		list("Essential Smartgunner Set", 0, /obj/item/storage/box/m56_system, VENDOR_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
		...
		list("Burst Fire Assembly", 0, /obj/item/attachable/burstfire_assembly, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("High-Capacity Power Cell", 0, /obj/item/cell/high, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
...
GLOBAL_LIST_INIT(cm_vending_clothing_smartgun, list(
		...
		list("M802 Smartgunner Sidearm Belt", 0, /obj/item/storage/belt/gun/smartgunner/full, VENDOR_CAN_BUY_BELT, VENDOR_ITEM_MANDATORY),
		...
		list("Electronics Pouch", 0, /obj/item/storage/pouch/electronics, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
		...
		list("Large Pistol Magazine Pouch", 0, /obj/item/storage/pouch/magazine/pistol/large, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_RECOMMENDED),
