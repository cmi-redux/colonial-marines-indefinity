...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("MOU-53 Shotgun", 20, /obj/item/storage/box/guncase/mou53, null, VENDOR_ITEM_REGULAR),
		list("M41AE2 Heavy Pulse Rifle", 14, /obj/item/storage/box/guncase/lmg, null, VENDOR_ITEM_REGULAR),
		list("M56D Heavy Machine Gun", 20, /obj/item/storage/box/guncase/m56d, null, VENDOR_ITEM_REGULAR),
		list("SGL2 Heavy Grenade Launcher Gun", 20, /obj/item/storage/box/guncase/sgl2, null, VENDOR_ITEM_REGULAR),
		list("RCT Heavy Rocket Launcher Gun", 20, /obj/item/storage/box/guncase/rct, null, VENDOR_ITEM_REGULAR),
		...
		list("Roller Bed", 6, /obj/item/roller, null, VENDOR_ITEM_REGULAR),
