...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_chief, list(
		...
		list("Satchel", 0, /obj/item/storage/backpack/satchel/sec, VENDOR_CAN_BUY_BACKPACK, VENDOR_ITEM_MANDATORY),
		list("Gear Belt", 0, /obj/item/storage/belt/security/mp/full, VENDOR_CAN_BUY_BELT, VENDOR_ITEM_MANDATORY),
		...
		list("Military Police Chief M3 Armor and Service Jacket", 0, /obj/item/clothing/suit/storage/marine/mp/WO/jacket, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Military Police Chief M3 Padless Armor", 0, /obj/item/clothing/suit/storage/marine/mp/WO/padless, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),

		list("COMBAT EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Military Police M10 Helmet", 0, /obj/item/clothing/head/helmet/marine/mp, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		...
		list("Security HUD Glasses", 0, /obj/item/clothing/glasses/sunglasses/sechud, VENDOR_CAN_BUY_GLASSES, VENDOR_ITEM_MANDATORY),
		...
		list("CMP Beret", 0, /obj/item/clothing/head/beret/marine/mp/cmp, VENDOR_CAN_BUY_MASK, VENDOR_ITEM_MANDATORY),
	))
...
GLOBAL_LIST_INIT(cm_vending_clothing_chief_engineer, list(
		...
		list("Magazine Pouch", 0, /obj/item/storage/pouch/magazine, (VENDOR_CAN_BUY_COMBAT_R_POUCH|VENDOR_CAN_BUY_COMBAT_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Shotgun Shell Pouch", 0, /obj/item/storage/pouch/shotgun, (VENDOR_CAN_BUY_COMBAT_R_POUCH|VENDOR_CAN_BUY_COMBAT_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Sidearm Pouch", 0, /obj/item/storage/pouch/pistol, (VENDOR_CAN_BUY_COMBAT_R_POUCH|VENDOR_CAN_BUY_COMBAT_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Flare Pouch (Full)", 0, /obj/item/storage/pouch/flare/full, (VENDOR_CAN_BUY_COMBAT_R_POUCH|VENDOR_CAN_BUY_COMBAT_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Fuel Tank Strap Pouch", 0, /obj/item/storage/pouch/flamertank, (VENDOR_CAN_BUY_COMBAT_R_POUCH|VENDOR_CAN_BUY_COMBAT_L_POUCH), VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_req_officer, list(
		...
		list("STANDARD EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Insulated Gloves", 0, /obj/item/clothing/gloves/yellow, VENDOR_CAN_BUY_GLOVES, VENDOR_ITEM_MANDATORY),
		list("RO Uniform", 0, /obj/item/clothing/under/rank/ro_suit, VENDOR_CAN_BUY_UNIFORM, VENDOR_ITEM_MANDATORY),
		list("Headset", 0, /obj/item/device/radio/headset/almayer/ro, VENDOR_CAN_BUY_EAR, VENDOR_ITEM_MANDATORY),
		...
		list("RO Jacket", 0, /obj/item/clothing/suit/storage/RO, VENDOR_CAN_BUY_MRE, VENDOR_ITEM_MANDATORY),
		...
		list("First-Aid Pouch (Pill Packets)", 0, /obj/item/storage/pouch/firstaid/full/pills, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_RECOMMENDED),
		list("Large General Pouch", 0, /obj/item/storage/pouch/general/large, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Tools Pouch (Empty)", 0, /obj/item/storage/pouch/tools, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
		list("Construction Pouch", 0, /obj/item/storage/pouch/construction, (VENDOR_CAN_BUY_R_POUCH|VENDOR_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
