...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police, list(
		...
		list("Essential Police Set", 0, /obj/effect/essentials_set/police, VENDOR_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
		...
		list("MP Beret", 0, /obj/item/clothing/head/beret/marine/mp, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_warden, list(
		...
		list("Warden Peaked Cap", 0, /obj/item/clothing/head/beret/marine/mp/warden, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
