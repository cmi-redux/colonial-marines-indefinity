...
/obj/structure/machinery/cm_vending/gear/vehicle_crew
	...
	vendor_role = list(JOB_CREWMAN, JOB_UPP_CREWMAN)
	bound_width = 64
...
/obj/structure/machinery/cm_vending/gear/vehicle_crew/proc/populate_products(datum/source, obj/vehicle/multitile/V)
	SIGNAL_HANDLER
	UnregisterSignal(SSdcs, COMSIG_GLOB_VEHICLE_ORDERED, V)

	if(istype(V, /obj/effect/vehicle_spawner/tank))
		selected_vehicle = "TANK"
	else if(istype(V, /obj/effect/vehicle_spawner/apc))
...
GLOBAL_LIST_INIT(cm_vending_clothing_vehicle_crew, list(
		...
		list("Tanker Armor", 0, /obj/item/clothing/suit/storage/marine/tanker, VENDOR_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("M50 Tanker Helmet", 0, /obj/item/clothing/head/helmet/marine/tech/tanker, VENDOR_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		list("SensorMate HUD", 0, /obj/item/clothing/glasses/hud/sensor, VENDOR_CAN_BUY_GLASSES, VENDOR_ITEM_MANDATORY),
		...
		list("M103 Vehicle-Ammo Rig", 0, /obj/item/storage/belt/tank, VENDOR_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
