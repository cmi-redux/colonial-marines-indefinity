...
DEFINE_BITFIELD(flags_ammo_behaviour, list(
	...
	"AMMO_SCANS_NEARBY" = AMMO_SCANS_NEARBY,
	"AMMO_HOMING" = AMMO_HOMING,
	"AMMO_MP" = AMMO_MP,
...
DEFINE_BITFIELD(projectile_flags, list(
	...
	"PROJECTILE_HITSCAN" = PROJECTILE_HITSCAN,
))

DEFINE_BITFIELD(projectile_status_flags, list(
	"PROJECTILE_FROZEN" = PROJECTILE_FROZEN,
	"PROJECTILE_ERROR" = PROJECTILE_ERROR,
...
DEFINE_BITFIELD(objective_flags, list(
	...
	"NO_FACTION_LINK" = OBJECTIVE_NO_FACTION_LINK,
))
...
DEFINE_BITFIELD(turf_flags, list(
	...
	"WEATHER_PROOF" = TURF_WEATHER_PROOF,
	"WEATHER_AFFECTABLE" = TURF_EFFECT_AFFECTABLE,
	"HULL" = TURF_HULL,
	"BURNABLE" = TURF_BURNABLE,
	"BREAKABLE" = TURF_BREAKABLE,
	"TRANSPARENT" = TURF_TRANSPARENT,
))
