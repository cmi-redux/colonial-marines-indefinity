...
export const ObjectivesMemories = (props, context) => {
  ...
  const { reward_points, theme, clue_categories } = data;

  return (
    <Window width={650} height={700} theme={theme}>
      <Window.Content scrollable>
        <Section title="Credit Points">
          <Box fontSize="16px">{reward_points}</Box>
        </Section>
...
const Objectives = (props, context) => {
  ...
  return (
    <Section
      ...
      buttons={
        <Button
          content={'Total earned points: ' + data.total_objectives_points}
